...
def fetch_data(vehicle, start_time, end_time, api_key):
...
def fetch_data_over_period(vehicle, start_date, end_date, api_key):
  all_data = []
  ...
  while current_start < end_date:
      ...
      data = fetch_data(vehicle, start_time_ms, end_time_ms, api_key)
      if data:
...
if st.button("Fetch and Process Data"):
  if vehicle and start_date and end_date:
      if start_date > end_date:
          ...
          data = fetch_data_over_period(vehicle, start_datetime, end_datetime, api_key)
